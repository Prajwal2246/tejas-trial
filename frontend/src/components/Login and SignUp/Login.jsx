				...
				<div className="relative bg-black/80 backdrop-blur-3xl rounded-[22px] border border-white/10 p-8 shadow-2xl">
					...
					<form className="space-y-6" onSubmit={handleLogin}>
						...
						<motion.button
							...
							type="submit"
							disabled={loading}
							className="cursor-pointer w-full py-4 bg-white text-black font-bold rounded-xl disabled:opacity-60"
						>
					...
					<div className="mt-8 text-center">
						<p className="text-slate-500 text-sm">
							...
							<button
								...
								className="cursor-pointer text-white hover:text-cyan-400 underline"
							>
								Initialize Sequence
							</button>
						</p>
